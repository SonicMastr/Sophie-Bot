	...
	execute(message, args) {
        try {
			...
			if(message.channel.nsfw) {
                ...
                const urlKon = 'https://konachan.com/post.xml?limit=250&tags=' + argR.join('_') + '+-loli+-furry+-yaoi%20order:score%20rating:explict';
                const urlDan = 'https://danbooru.donmai.us/posts.xml?limit=250&tags=' + argR.join('_') + '%20rating:explict';
                const urlYan = 'https://yande.re/post.xml?limit=250&tags=' + argR.join('_') + '+-loli+-furry+-yaoi%20order:score%20rating:explict';
                const urlGel = 'https://www.gelbooru.com/index.php?page=dapi&s=post&q=index&limit=250&tags=' + argR.join('_') + '+-loli+-pokemon+-futanari+-furry+-yaoi+sort%3ascore%3adesc+rating%3aexplicit';
