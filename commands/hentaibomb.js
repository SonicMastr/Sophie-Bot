	...
	execute(message, args) {
        try {
			...
			if(message.channel.nsfw) {
                ...
                const urlGel = 'https://www.gelbooru.com/index.php?page=dapi&s=post&q=index&limit=250&tags=' + argR.join('_') + '+-shota+-animal+-futanari+-furry+-yaoi+sort%3ascore%3adesc+rating%3aexplicit';
